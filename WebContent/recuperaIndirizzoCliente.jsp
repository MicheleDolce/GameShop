...
body{font-weight:bold;}body{background-image: url('img/crysis.jpg') !important;color:red;}</style>
		...
		<h:form>
			<div>
				Id:
				<h:inputText value="#{ordineController.id}" required="true"
					requiredMessage="campo obbligatorio" id="id" />
				<h:message for="id" />
			</div>
			<div>
				<h:commandButton value="Submit"
					action="#{ordineController.mostraCliente}" />
			</div>
		...
		<h:form>
				<h:commandLink
					action="#{ordineController.mostraElencoOrdini()}"
					value="Vedi elenco ordini" />
			</h:form>
